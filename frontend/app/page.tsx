...
const integrations = [
  { name: "Airflow", icon: <Database /> },
  { name: "Auth0", icon: <Database /> },
  { name: "Axiom", icon: <Database /> },
  { name: "Beehiiv", icon: <Database /> },
  { name: "Betterstack", icon: <Database /> },
  { name: "Bitbucket", icon: <Database /> },
  { name: "Cal", icon: <Database /> },
  { name: "Clear Ml", icon: <Database /> },
  { name: "Clerk", icon: <Database /> },
  { name: "Clickhouse", icon: <Database /> },
  { name: "Clickhouse Mcp", icon: <Database /> },
  { name: "Clickup", icon: <Database /> },
  { name: "Cloudflare", icon: <Database /> },
  { name: "Cloudwatch Logs", icon: <Database /> },
  { name: "Cloudwatch Metrics", icon: <Database /> },
  { name: "Codecov", icon: <Database /> },
  { name: "Confluence", icon: <Database /> },
  { name: "Coralogix", icon: <Database /> },
  { name: "Crates Io", icon: <Database /> },
  { name: "Databricks", icon: <Database /> },
  { name: "Datadog", icon: <Database /> },
  { name: "Datahub", icon: <Database /> },
  { name: "Dbt Cloud", icon: <Database /> },
  { name: "Digitalocean", icon: <Database /> },
  { name: "Dub", icon: <Database /> },
  { name: "Elasticsearch", icon: <Database /> },
  { name: "Figma", icon: <Database /> },
  { name: "Fly", icon: <Database /> },
  { name: "Ghost", icon: <Database /> },
  { name: "GitHub", icon: <Database /> },
  { name: "GitLab", icon: <Database /> },
  { name: "Google Drive", icon: <Database /> },
  { name: "Grafana", icon: <Database /> },
  { name: "Groq Ai", icon: <Database /> },
  { name: "Hacker News", icon: <Database /> },
  { name: "Honeycomb", icon: <Database /> },
  { name: "Hubspot", icon: <Database /> },
  { name: "Huggingface", icon: <Database /> },
  { name: "Incident Io", icon: <Database /> },
  { name: "Influxdb", icon: <Database /> },
  { name: "Intercom", icon: <Database /> },
  { name: "Jenkins", icon: <Database /> },
  { name: "Jira", icon: <Database /> },
  { name: "K8s", icon: <Database /> },
  { name: "Kafka", icon: <Database /> },
  { name: "Kestra", icon: <Database /> },
  { name: "Keycloak", icon: <Database /> },
  { name: "Langfuse", icon: <Database /> },
  { name: "Langsmith", icon: <Database /> },
  { name: "Launchdarkly", icon: <Database /> },
  { name: "Linear", icon: <Database /> },
  { name: "Loops", icon: <Database /> },
  { name: "Mailgun", icon: <Database /> },
  { name: "Milvus", icon: <Database /> },
  { name: "Mixpanel", icon: <Database /> },
  { name: "N8n", icon: <Database /> },
  { name: "Neo4j", icon: <Database /> },
  { name: "Neondb", icon: <Database /> },
  { name: "Netlify", icon: <Database /> },
  { name: "Notion", icon: <Database /> },
  { name: "Novu", icon: <Database /> },
  { name: "Okta", icon: <Database /> },
  { name: "Openobserve", icon: <Database /> },
  { name: "Opsgenie", icon: <Database /> },
  { name: "Osv", icon: <Database /> },
  { name: "Pagerduty", icon: <Database /> },
  { name: "Pinecone", icon: <Database /> },
  { name: "Plausible", icon: <Database /> },
  { name: "Posthog", icon: <Database /> },
  { name: "Postman", icon: <Database /> },
  { name: "Postmark", icon: <Database /> },
  { name: "Prefect", icon: <Database /> },
  { name: "Prometheus", icon: <Database /> },
  { name: "Qdrant Cloud", icon: <Database /> },
  { name: "Rabbitmq", icon: <Database /> },
  { name: "Remotive", icon: <Database /> },
  { name: "Resend", icon: <Database /> },
  { name: "Sendgrid", icon: <Database /> },
  { name: "Sentry", icon: <Database /> },
  { name: "Shopify", icon: <Database /> },
  { name: "Signoz", icon: <Database /> },
  { name: "Slack", icon: <Database /> },
  { name: "Splunk", icon: <Database /> },
  { name: "Statusgator", icon: <Database /> },
  { name: "Stripe", icon: <Database /> },
  { name: "Tailscale", icon: <Database /> },
  { name: "Todoist", icon: <Database /> },
  { name: "Travis Ci", icon: <Database /> },
  { name: "Trino", icon: <Database /> },
  { name: "Turso", icon: <Database /> },
  { name: "Umami Cloud", icon: <Database /> },
  { name: "Upstash", icon: <Database /> },
  { name: "Vercel", icon: <Database /> },
  { name: "Wandb", icon: <Database /> },
  { name: "Weaviate", icon: <Database /> },
  { name: "Woocommerce", icon: <Database /> },
  { name: "Zulip", icon: <Database /> },
];
